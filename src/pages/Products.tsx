...
const products = [
  ...
  },
  {
    id: 'witylogix',
    name: 'WityLogix AI',
    tagline: 'Intelligence-as-a-Utility for Last-Mile Logistics',
    description: 'High-utility routing logic that optimizes delivery flows with industrial-grade precision. Built for speed, scaled for sustainability.',
